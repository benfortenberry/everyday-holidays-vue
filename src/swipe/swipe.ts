...
export const useSwipe = (
  touchableElement: HTMLElement,
  options: Ref<SwipeOptions> = ref({
  ...
  return {
    onSwipeLeft: (callback: SwipeCallback) =>
      addEventListener(onSwipeLeft, callback),
    onSwipeRight: (callback: SwipeCallback) =>
      addEventListener(onSwipeRight, callback),
    onSwipeUp: (callback: SwipeCallback) =>
      addEventListener(onSwipeUp, callback),
    onSwipeDown: (callback: SwipeCallback) =>
      addEventListener(onSwipeDown, callback),
